...
Facilitators: Rhonda Glennon, Diana Shkolnikov, Katie Kowalsky - [Mapzen](https://mapzen.com/)
...
- Hands-on tutorial: Add Mapzen Search box to a Leaflet map (most of the workshop is here)
...
- [CARTO Academy and free accounts](https://carto.com/academy/) - geocoding credits and free storage space
